...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_DB") or "budgetapi",
        "USER": os.getenv("POSTGRES_USER") or "budgetapi",
        "PASSWORD": os.getenv("POSTGRES_PASSWORD") or "budgetapi",
        "HOST": os.getenv("POSTGRES_HOST") or "postgres" or "localhost",
